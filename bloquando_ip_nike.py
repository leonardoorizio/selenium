...
driver.get('https://www.nike.com.br/nav/ofertas/emoferta')
sleep(2)
driver.maximize_window()
sleep(2)

like = driver.find_elements(By.CLASS_NAME,'SvgIcon__Icon-sc-9dg20d-0 SvgIcon-sc-9dg20d-1 cxStEi gjIExv ProductCardFavoriteButton-styled__FavoriteHeartOutline-sc-22f33b63-2 jnNops')
cookies = driver.find_element(By.ID,'adopt-accept-all-button')
