...
if botao_1.is_enabled():
    print('Campo 1 habilitado')
else:
    print('Campo 1 desabilitado')

if botao_2.is_enabled():
    print('Campo 2 habilitado')
else:
    print('Campo 2 desabilitado')

if botao_3.is_enabled():
    print('Campo 3 habilitado')
else:
    print('Campo 3 desabilitado')
